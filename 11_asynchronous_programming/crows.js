...
const $storage = Symbol("storage"), $network = Symbol("net");
...
let net = new Network(connections, storageFor);
bigOak = net.nodes["Big Oak"];
everywhere = net.everywhere.bind(net);
defineRequestType = net.defineRequestType.bind(net);
